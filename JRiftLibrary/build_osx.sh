...
cd "$SCRIPTDIR/osx64"
cmake -DCMAKE_OSX_ARCHITECTURES=x86_64 -DCMAKE_OSX_DEPLOYMENT_TARGET=10.7 "$SCRIPTDIR" -Wno-dev
make
...
cd "$SCRIPTDIR/osx32"
cmake -DCMAKE_OSX_ARCHITECTURES=i386 -DCMAKE_OSX_DEPLOYMENT_TARGET=10.7 "$SCRIPTDIR" -Wno-dev
make
